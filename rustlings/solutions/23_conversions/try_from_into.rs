...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    // }
     ...
     fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        let (red, green, blue) = (
            TryInto::<u8>::try_into(tuple.0).map_err(|_| Self::Error::IntConversion)?,
             TryInto::<u8>::try_into(tuple.1).map_err(|_| Self::Error::IntConversion)?,
             TryInto::<u8>::try_into(tuple.2).map_err(|_| Self::Error::IntConversion)?,
            );
        Ok(Self{red,green,blue})
    }
}
